...
<body>
	...
	<div id="search">
		<form>
			<table><tr>
				<td>Показать товары у которых:</td> 
				<td id="select1" style="text-align:left;">
					<input type="radio" name="cost" value="Cost" checked><label>Розничная цена</label><br>
					<input type="radio" name="cost" value="WholesaleCost"><label>Оптовая цена</label>
				</td>
				<td>от</td>
				<td><input type="text" name="cost_min" placeholder="Минимальное значение"></td>
				<td>до</td>
				<td><input type="text" name="cost_max" placeholder="Максимальное значение"></td>
				<td>рублей на складе</td>
				<td id="select2" style="text-align:left;">
					<input type="radio" name="more" value="0" checked><label>Более</label><br>
					<input type="radio" name="more" value="1"><label>Менее</label>
				</td>
				<td><input type="text" name="number" placeholder="Количество товара"></td>
				<td>штук.</td>
				<td><input type="button" value="Найти" id="submit" onclick = "getdetails()"></td>
			</tr></table>
		</form>
	</div>	
	<br>
...
<table >
	<thead>
		<tr>
	    	<th>№ <br>п/п</th>
	    	<th>Наименование</th>
	    	<th>Розничная<br>стоимость</th>
	    	<th>Оптовая<br>стоимость</th>
	    	<th>Склад 1,<br>кол-во</th>
	    	<th>Склад 2,<br>кол-во</th>
	    	<th>Страна</th>
	    	<th>Примечание</th>
	    <tr>
	</thead>
